...
class OneActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        EventChannelManager(this, flutterView).sendAndroid2FlutterNet()
        EventChannelManager(this, flutterView).sendAndroid2FlutterBack()
        EventChannelManager(this, flutterView).sendAndroid2FlutterDefault()

        MethodChannelManager(this, flutterView).registerAndBackFlutter2Android()
        BasicMessageChannelManager(this,flutterView).registerFlutter2Android()
        BasicMessageChannelManager(this,flutterView).registerFlutter2AndroidBinary()
...
//                    EventChannelManager(this, flutterView).sendAndroid2FlutterNet()
        ...
        findViewById<TextView>(R.id.send_basic_message)
            .setOnClickListener {
                ...
                BasicMessageChannelManager(this,flutterView).sendAndroid2Flutter("send to flutter from native by BasicMessageChannelManager")
            }

        findViewById<TextView>(R.id.send_basic_message_binary)
            .setOnClickListener {
                // BasicMessageChannelManagerBinary 发送消息
                BasicMessageChannelManager(this,flutterView).sendAndroid2FlutterBinary()
            }
    }

    override fun onBackPressed() {
        BasicMessageChannelManager(this,flutterView).sendAndroid2Flutter("back")
//        super.onBackPressed()
    }
}
